...
NAMED_PERIODS = {
    ...
    'harmonic-2'          : rv.uniform_choice([100, 125, 150, 175, 200, 250, 300, 400]),
    'uni-short'           : rv.uniform_int( 3,  33),
    'uni-moderate'        : rv.uniform_int(10, 100),
    'uni-long'            : rv.uniform_int(50, 250),
    'uni-very-long'       : rv.uniform_int(100, 1000),
}

NAMED_UTILIZATIONS = {
    'uni-very-light': rv.uniform(0.0001, 0.001),
    'uni-light'     : rv.uniform( 0.001, 0.1),
    'uni-low-2'     : rv.uniform( 0.025, 0.1),
    'uni-low'       : rv.uniform(  0.05, 0.2),
    'uni-medium'    : rv.uniform(   0.1, 0.4),
    'uni-medium-1'  : rv.uniform(   0.1, 0.3),
    'uni-medium-2'  : rv.uniform( 0.075, 0.425),
    'uni-medium-3'  : rv.uniform( 0.075, 0.35),
    'uni-heavy'     : rv.uniform(   0.5, 0.9),
    'uni-mixed'     : rv.uniform( 0.001, 0.4),
